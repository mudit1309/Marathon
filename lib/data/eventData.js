...
export const eventInfo = {
  ...
  subtitle: "Noida's Premier Eco Half Marathon",
  tagline: "Run to the Future. Protect the Planet.",
  intro:
    "Mojo Marathons is Noida's biggest running festival — where serious athletes, everyday runners, corporate teams and families unite for a race built on passion, performance and a greener planet.",
  edition: "2nd Edition",
  ...
  title: [
    {
      name: "Apex Corporate",
      slug: "apex-corporate",
      logoUrl: "/sponsors/apex-corporate.svg",
